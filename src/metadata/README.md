 ...
 * [capo.yml](capo.yml)
     * Determines how your purl.obolibrary.org/obo/capo/ redirects will be handled
     ...
     * Paste in the contents of [capo.yml](capo.yml)
 ...
 * [capo.md](capo.md)
     ...
     * Paste in the contents of [capo.md](capo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
