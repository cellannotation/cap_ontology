These notes are for the EDITORS of capo
...
Make sure you have an ID range in the [idranges file](capo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [capo-edit.owl](capo-edit.owl)

** DO NOT EDIT capo.obo OR capo.owl in the top level directory **

[../../capo.owl](../../capo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/kharchenkolab/cap_ontology) for details.
 ...
 * [capo-idranges.owl](capo-idranges.owl)
...
This generates derived files such as capo.owl and capo.obo and places
 ...
 * https://github.com/kharchenkolab/cap_ontology/releases
 * https://github.com/kharchenkolab/cap_ontology/releases/new
...
what is in the `owl:versionIRI` of the derived capo.owl (`data-version` in
capo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/capo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/capo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/kharchenkolab/cap_ontology.svg?branch=master)](https://travis-ci.org/kharchenkolab/cap_ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/kharchenkolab](https://travis-ci.org/profile/kharchenkolab)
 2. click the "Sync account" button
 3. Click the tick symbol next to cap_ontology
